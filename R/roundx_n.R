...
#'
#' @param x A numeric value to be rounded. Values >= 100 are rounded to 1 decimal
#'   place. Values < 100 and >=1 are rounded to two decimal places. Values <1
#'   are rounded to three decimal places.
#'
#' @return numeric value rounded based on magnitude of x
#' @export
#'
#' @examples
